...
{
 public:
  ESP_AVRISP(uint16_t port, uint8_t cipo, uint8_t copi, uint8_t clk,
             uint8_t reset_pin, uint32_t spi_freq = AVRISP_SPI_FREQ,
             bool reset_state = false, bool reset_activehigh = false);
